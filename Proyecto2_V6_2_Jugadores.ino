...
uint8_t flag1 = 2; //random(0,2);              //Bandera para las rutinas del J1
...
void loop() {
  ...
  //LCD_Print(String(x1), 100, 110, 1, 0x0255, 0x0000);
  //LCD_Print(String(), 240, 110, 1, 0x0255, 0x0000);
    ...
    if (x1 > 43) {
      ...
      if (posy_J1 == 180) {
        ...
        if (180 - posy_secJ1 < 12) {
          LCD_Print("Game Over", 100, 110, 1, 0x0255, 0x0000);
        }
      }
