...
uint8_t flag1 = 4;//random(0,2);              //Bandera para las rutinas del J1
uint8_t flag2 = 2;//random(0,2);            //Bandera para las rutinas del J2
...
void setup() {
  ...
  pinMode(Musica_Juego, OUTPUT);
  pinMode(Musica_Perdio, OUTPUT);

  digitalWrite(Musica_Juego, HIGH);
  digitalWrite(Musica_Perdio, LOW);
...
//***************************************************************************************************************************************  
  if (Estado == false) {
    ...
    if (perd_J1 == 1) {
      digitalWrite(Musica_Perdio, HIGH);
      LCD_Clear(0x14F4);
...
//***************************************************************************************************************************************
    ...
    if (!digitalRead(SALTAR_J2)) {
      ...
      if (x2 > 259) {
        ...
        //Si el jugador llega al borde de arriba de la pantalla o toca el suelo, reinice la posicion del jugador
        if (posy_secJ2 == 0) {
          posy_J2 = 180;
          posy_secJ2 = 180;
...
//***************************************************************************************************************************************
    if (flag2 == 0) {                                                         //RUTINA 1
      if (AparicionBloque1Izq == 0 & cont2 == 0) {                            //REVISIÓN DE BANDERA Y CONTADOR
        ...
        Plataforma2Izq(7, 154);                                             //EJECUCIÓN DE LA FUNCIÓN DEL SPRITE
    ...
    if (flag2 == 2) {
      if (AparicionBalaIzq == 0 & cont2 == 0) {
        ...
        AparicionBloque1Izq = 0;
        Plataforma2Izq(7, 154);
        if (AparicionBloque2Izq == 1) {
          cont2 = 4;
        }
      } if (cont2 == 4) {
        AparicionBloque2Izq = 0;
        Plataforma2Izq(7, 128);
        if (AparicionBloque2Izq == 1) {
          cont2 = 5;
        }
      } if (cont2 == 5) {
