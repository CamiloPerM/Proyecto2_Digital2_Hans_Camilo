...
uint8_t cont = 0;                         //contador para las rutinas

uint8_t flag1 = random(0,2);              //Bandera para las rutinas del J1
//uint8_t flag2 = random(0,2);            //Bandera para las rutinas del J2
...
void Plataforma1Izq(uint8_t modulo, uint8_t y){
  ...
  if((CONTADOR/2)%modulo == 0){
    ...
    if(x2 < 250){                                                          //Revisión si se llego a la distancia requerida
      x2 = 297;
